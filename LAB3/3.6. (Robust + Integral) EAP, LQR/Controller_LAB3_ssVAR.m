...
% used for generic Torque Disturbance Modeling (not present here)
B_prime_d = [
    0;
    0;
    -1 / (gbox.N^2 * Jeq);
...
%%  Extended SSM for Robust + Integral Action

Ae =  [0 C_prime; zeros(4,1) A_prime];
Be =  [0; B_prime];
Ce =  [0 C_prime];
De =  0;
...
%% Eigenvalue Placement (including an eigenvalue for the Integral term):
...
p = [lambda_1 lambda_2 lambda_3 lambda_4 lambda_5];
