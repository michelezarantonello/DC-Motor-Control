...
Additionally, a video demonstration is included (https://github.com/michelezarantonello/dc-motor-control/VIDEO_LAB4_Controller), showing how the robot — which is inherently unstable — is stabilized and controlled using the controller designed in Lab 4, which is robust to external disturbances.
